...
interface CourtCaseResultProps {
  ...
  onResultsChange?: (results: any) => void; // Add this line to the interface
}

const CourtCaseResult: FC<CourtCaseResultProps> = ({
  profileData,
  onResultsChange,
}) => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      // Call the callback to pass results to parent component
      if (onResultsChange) {
        onResultsChange({
          allCourtCases: data.cases || [],
          casesFound: data.casesFound || 0,
          ...
          <div className="flex-1">
            <div className="flex items-center mb-1">
              ...
              {caseData.advancedAnalysis && (
                <span title="Advanced Analysis Applied">
                  <Zap
