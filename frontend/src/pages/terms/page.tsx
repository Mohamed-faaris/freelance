      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Welcome to ARGUS. These terms of service ("Terms") apply to your
            access and use of ARGUS (the "Service") provided by ARGUS Inc.
            ("we", "us", or "our").
          </p>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              In no event shall ARGUS, nor its directors, employees, partners,
          ...
          <section className="mb-8">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="mb-2">
                <strong>Email:</strong> legal@argus.com
              </p>
              <p>
                <strong>Address:</strong> ARGUS Inc., 123 Business St., City,
                State 12345
              </p>
            </div>
          </section>
