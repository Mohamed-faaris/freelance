  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/search?page=1&limit=${searchParams.resultsPerPage}`,
        {
          method: "POST",
          headers: {
      ...
      <div className="p-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4 mb-6">{renderSearchFields()}</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleInputChange("searchIn", e.target.value)
                  }
                  className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                    darkMode
                      ? "bg-gray-700 border-gray-600 text-white"
              ...
              <div className="flex items-end">
                <label className="flex items-center">
                  <input
                    ...
                    className={`mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500 rounded transition-colors duration-200 ${
                      darkMode
                        ? "border-gray-600 bg-gray-700 focus:ring-blue-400"
            ...
            <button
              ...
              disabled={loading}
              className={`w-full py-3 px-6 rounded-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 ${
                darkMode
                  ...
                  >
                    ...
                    >
                      <p>
                        ...
                        {result.cnr || result.caseNumber || result.id || "N/A"}
                      </p>
                      <p>
                        <strong>Court:</strong>{" "}
                        {result.court ||
                          courtModules.find((c) => c.id === selectedCourt)
                            ?.name}
                      </p>
                      ...
                      {result.parties && (
                        <p>
                          <strong>Parties:</strong> {result.parties}
                        </p>
                      )}

                      <p>
                        <strong>Status/Stage:</strong>{" "}
                        {result.stage || result.status || "Not specified"}
                      </p>

                      {result.nextDate && (
                        <p>
                          <strong>Next Date:</strong> {result.nextDate}
                        </p>
                      )}

                      {result.establishment && (
                        <p>
                          <strong>Establishment:</strong> {result.establishment}
                        </p>
                      )}
                    </div>
